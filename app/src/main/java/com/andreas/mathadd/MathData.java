...
public class MathData extends BaseObservable{
    ...
    /**
     * Method to increase carry number by one at the given index.
     * @param index between 0 and 3
     */
    ...
    /**
     * Method to increase result number by one at the given index.
     * @param index between 0 and 4
     */
    ...
    //Method to generate a 4 digit random number as an integer array
